...
sed -i -e 's_^_https://_' $url/recon/initial.txt # this adds https:// to the beginning of each line of our new file as the following tools appreciate the formality. 
